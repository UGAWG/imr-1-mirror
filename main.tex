...
They also document remaining challenges.
...
potential imapcts of improved capability.
This is provided in the context of the 
CFD Vision 2030 Study by Slotnick et al.\cite{cfd-vision-2030}~provide
...
These benchmarks are redily available to foster collaboration
...
anisotropic grid adaptation technology ubiquitous and truely impacting
workflows or practitioners.
Appendix C of Park et al.\cite{park-unstruct-adapt-status-cfd2030}
addresss the critial adoption piece of this technology and
advocate the need for mulitple implementations, 
because research in technology diffusion has identified the
...
This benchwark is a continuation of the efforts of
Park et al.\cite{park-loseille-krakos-michal-adapt-decomposition}
to decompose the solution adaprive process into a number of
elements that can be indepentently verified and imporved.
The current version of the benchmarks focus on the grid adaptation
mechanics.
Extensions of the benchmarks are envisied that examine error
estimation.
Michal et al.\cite{michal-unstruct-adapt-epic-dpw6}~show that
a reliable error estiamation can reduce the efficency of advanced
automated anisotropic grid adaptation methods.
This benchmark could also become a
precurser to a workshop (see Levy et al.\cite{dpw5-summary}~or
Rumsey and Slotnik\cite{rumsey-slotnick-summary-highliftpw2} for examples)
as the size of the solution adaptive comunity grows.

This paper describes an effort to provide a benchmark
of anisotropic grid adaptation tools 
to the greater comunity.
This allows comparing different implementations
...
operators. EPIC development has focused on industrial aerospace CFD 
...
get slighly better element counts (45K).

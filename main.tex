...
The next benchmark cases consisting of the Cube-Cylinder model and Polar-1 Metric begins to explore {\color{blue}the interaction between curved geometry in the presence of a geometry aligned highly anisotropic metric field}.
...
The libMeshb \cite{libMeshb-website} format was chosen as the common file format for transferring mesh data between the meshers and the mesh evaluation tool {\color{blue}What are these evaluation tools ??}.
...
{\color{blue}Say it's a NASA code ?}
...
{\color{blue} Why not length histo for this case ?}
...
%The necessary level of discretisation

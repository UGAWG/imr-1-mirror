...
via histograms.
One interesting pattern is the presence of two local maxima
...
histogram bin and creating two edges in bins below the threshold.
...
will redistribute the lengths of all edges (FEFLO.A TEAM PLEASE
CONFIRM YOU USE SMOOTHING).

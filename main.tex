...
currently available anisotropic grid adaptation methods and
address the deficiencies in current tools.
These benchmarks are redily available to foster collbeation
bettween extablished international reserachers and new
...
advocate need for mulitple implementations, 
...
product in technolgy adoption.

Michal et al.\cite{michal-unstruct-adapt-epic-dpw6}

contiue with 
Park et al.\cite{park-loseille-krakos-michal-adapt-decomposition}
decompiosed in past

precurser to related things like the AIAA workshops,
but not used because of size of the comunity.
